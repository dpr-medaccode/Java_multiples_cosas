...
public class PeliculaDAO {
    ...
    public static ArrayList<Pelicula> titulosRepetidos(ArrayList<Pelicula> peliculas) {

        HashMap<Pelicula, Integer> map = new HashMap<Pelicula, Integer>();

        for (Pelicula pelicula : peliculas) {

            if (map.containsKey(pelicula)) {

                map.put(pelicula, map.get(pelicula) + 1);
