        ...
        do {
            ...
            switch (accion) {
                ...
                case /* Buscar reservas por título de pelicula */ 7 -> {
                    ...
                    // talzez hay cosas hechas por chat gpt, pero son las 2 de la mañana y tengo que
                    // ponerme mañana con el resto del 3, 4 y bases, no tengo tiempo, pero lo
                    // entiendo lo que he puesto, es todo el rato lo mismo, es facil pero implementar cada caso es
                    // muy tardado, gracias por la comprension
